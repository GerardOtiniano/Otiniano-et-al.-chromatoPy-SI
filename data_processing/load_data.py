...
def load_chraomtopy_and_manual():
    # Load datasets
    ...
    # Separate misidentified sample
    misid_names = ['H1608000196', 'H1608000191', 'H1608000189', 'H2102002', 'H2102003', 'H2102004']
    df, df_sans_mis_id = remove_mis_id(df, misid_names)
    return df, df_sans_mis_id
